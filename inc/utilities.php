...
add_filter( 'embed_oembed_html', 'rsdncschsll_embed_oembed_html', 99, 4 );
 ...
 * @param arr $attr Array of attributes.
 * @param int $post_id The post ID.
 * @see  https://wordpress.org/support/topic/adding-a-wrapping-div-to-video-embeds/#post-2671537
 */
function rsdncschsll_embed_oembed_html( $html, $url, $attr, $post_id ) {
